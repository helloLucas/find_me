...
/**
 * HTTP 쿠키 설정을 위한 공통 유틸리티 클래스입니다.
 * 애플리케이션 전반에서 일관된 쿠키 속성(HttpOnly, Secure, SameSite 등)을 보장합니다.
 */
@Component
public class CookieUtil {
  ...
  /**
   * Refresh Token을 HttpOnly 쿠키로 응답에 추가합니다.
   * SameSite=None, Secure=true 속성을 통해 크로스-오리진 환경에서도 안전하게 전달됩니다.
   *
