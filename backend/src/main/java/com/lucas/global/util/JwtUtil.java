...
public class JwtUtil {
    ...
    public String getProvider(String token) {
        return Jwts.parser().verifyWith(secretKey).build()
            .parseSignedClaims(token).getPayload().get("provider", String.class);
    }
    ...
    public String createAccessToken(Long userId, String email, String nickname, AuthProvider provider, String role, Long expiredMs) {
        return Jwts.builder()
