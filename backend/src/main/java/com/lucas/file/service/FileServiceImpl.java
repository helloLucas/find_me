...
public class FileServiceImpl implements FileService {
  ...
  @Override
  public DownloadPresignedUrlResponseDto getDownloadPresignedUrl(
      DownloadPresignedUrlRequestDto request) {
    ...
    try {
      ...
      log.error(
          "다운로드 Presigned URL 발급 실패. objectKey={}, statusCode={}, message={}",
          objectKey,
          e.statusCode(),
