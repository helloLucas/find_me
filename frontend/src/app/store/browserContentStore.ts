...
interface BrowserContentState {
  ...
  triggerLucasRouteTabClick: (options?: { storyLinked?: boolean }) => void;
  setLucasRouteStoryLinked: (storyLinked: boolean) => void;
...
export const useBrowserContentStore = create<BrowserContentState>((set) => ({
  ...
  triggerLucasRouteTabClick: (options) => set((state) => ({
    lucasRouteTabClickTrigger: state.lucasRouteTabClickTrigger + 1,
    lucasRouteStoryLinked: Boolean(options?.storyLinked),
  })),
  setLucasRouteStoryLinked: (storyLinked) => set({ lucasRouteStoryLinked: storyLinked }),
  resetLucasRouteTabClickTrigger: () => set({ lucasRouteTabClickTrigger: 0, lucasRouteStoryLinked: false }),
  ...
  resetContent: () => set({ content: {}, isRelayClueUnlocked: false, isChapter2Mode: false, lastCopiedCommand: null, newsTabClickTrigger: 0, cyberPacketDashTabClickTrigger: 0, lucasRouteTabClickTrigger: 0, lucasRouteStoryLinked: false, lucasSurvivalTabClickTrigger: 0, newsScrollTop: 0, searchHistory: [] }),
}));
