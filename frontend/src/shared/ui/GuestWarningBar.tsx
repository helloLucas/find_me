    ...
    return (
        <>
            ...
            >
                ...
                <p className="text-[9px] md:text-[15px] text-yellow-500 font-lobby tracking-tighter">
                    Change to User Mode
                </p>
                <span className="text-[9px] text-white border border-white/40 px-2 py-0.5 font-lobby group-hover:bg-white group-hover:text-black transition-colors">
                    LOGIN
                </span>
            </div>
