...
export const DEFAULT_NEWS_CARDS: NewsCard[] = [
  {
    id: "good_article",
...
export const FALLBACK_ARTICLES: Record<string, { title: string; body: string[] }> = {
  good_article: {
    title: "넥서스, 인류의 삶을 바꾼 완전 연결 시스템",
    body: [
  ...
  dark_article: {
    ...
    body: [
      ...
      "특히 이런 제보는 사람이 적은 시간과 장소에 집중돼 있다. 번화가 중심부나 대형 상업 지구처럼 유동 인구가 많은 구역보다, 외곽 도로와 심야 버스 노선, 재개발이 멈춘 구역, 폐쇄된 공공시설 주변에서 유사 사례가 반복적으로 보고되고 있다. 넥서스의 생활 인프라망이 촘꼼히 연결된 중심권은 비교적 안정적으로 보이지만, 시선이 드물게 머무는 공간일수록 배경이나 인물의 형태가 늦게 또렷해진다는 증언이 많았다.",
